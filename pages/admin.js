                        ...
                        <li key={submission.id} className="flex items-center justify-between gap-x-6 py-5">
                          <div className="flex items-center gap-x-4 min-w-0">
                            ...
                            <div className="flex-shrink-0">
                              {submission.studentData.profilePicture && typeof submission.studentData.profilePicture === 'string' && submission.studentData.profilePicture.trim() !== '' ? (
                                <img
                              ...
                              <div className={`h-12 w-12 rounded-full bg-gray-100 flex items-center justify-center ring-2 ring-gray-200 ${submission.studentData.profilePicture && typeof submission.studentData.profilePicture === 'string' && submission.studentData.profilePicture.trim() !== '' ? 'hidden' : 'flex'}`}>
